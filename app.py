        ...
        ">
            ...
            <div style="display:flex; gap:10px; margin-bottom:16px; flex-wrap:wrap;">
                <div style="flex:1; min-width:200px; background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:10px 14px;">
                    <div style="font-size:10px; font-weight:700; color:#60a5fa; text-transform:uppercase; letter-spacing:0.08em; margin-bottom:4px;">
                        ● URL A
                    </div>
                    <div style="font-size:12px; color:#93c5fd; font-family:monospace; word-break:break-all;">
                        {r.get("url_a", "N/A")}
                    </div>
                </div>
                <div style="flex:1; min-width:200px; background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:10px 14px;">
                    <div style="font-size:10px; font-weight:700; color:#34d399; text-transform:uppercase; letter-spacing:0.08em; margin-bottom:4px;">
                        ● URL B
                    </div>
                    <div style="font-size:12px; color:#6ee7b7; font-family:monospace; word-break:break-all;">
                        {r.get("url_b", "N/A")}
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex; gap:8px; flex-wrap:wrap;">
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if ci_count > 0 else '#34d399'};">{ci_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">Content</div>
                </div>
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if li_count > 0 else '#34d399'};">{li_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">Links</div>
                </div>
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if ii_count > 0 else '#34d399'};">{ii_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">Images</div>
                </div>
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if ti_count > 0 else '#34d399'};">{ti_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">Titles</div>
                </div>
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if si_count > 0 else '#34d399'};">{si_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">Status</div>
                </div>
                <div style="background:#0d1117; border:1px solid #1e2a3a; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if ssl_count > 0 else '#34d399'};">{ssl_count}</div>
                    <div style="font-size:10px; color:#6b7280; margin-top:2px;">SSL</div>
                </div>
                <div style="background:#0d1117; border:1px solid {'#ef4444' if total_iss > 0 else '#10b981'}; border-radius:8px; padding:8px 14px; text-align:center; min-width:80px;">
                    <div style="font-size:18px; font-weight:700; color:{'#f87171' if total_iss > 0 else '#34d399'};">{total_iss}</div>
